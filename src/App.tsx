...
const PedagogDashboard = () => (
  <div className="max-w-6xl mx-auto">
    <h1 className="text-3xl font-bold text-gray-900">O'qituvchi Boshqaruv Paneli</h1>
    ...
    <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {[
        ...
        <div key={i} className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl transition-all">
