...
export default function MethodicalWork({ targetUserId }: WorkProps) {
  const { t } = useLanguage();
  ...
  return (
    <div className="max-w-full overflow-x-hidden">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">{t('methodicalWork')}</h1>
          <p className="text-gray-500 dark:text-gray-400 mt-1">O'quv-uslubiy ishlarni boshqarish jadvali.</p>
        </div>
